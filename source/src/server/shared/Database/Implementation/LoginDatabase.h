...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_INS_IP_MASKING,
    LOGIN_SEL_IP_MASKING_MASK_FROM_IP,
    LOGIN_SEL_IP_MASKING_IP_FROM_MASK,

    LOGIN_SEL_ACCOUNT_ACCESS_FLAGS,

    LOGIN_SEL_GUEST_SINGLE,
    LOGIN_SEL_GUEST_ALL,
    LOGIN_INS_GUEST,
    LOGIN_DEL_GUEST,

    LOGIN_SEL_ACCOUNT_PREMIUM,
    LOGIN_REP_ACCOUNT_PREMIUM,

    LOGIN_REP_FACTION_RATIO,

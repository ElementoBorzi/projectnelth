...
Position const Talon_spawns[8]
{
    {   216.638824f,   -392.817596f, 106.152809f,   2.896962f   },//High back left
    {   165.285721f,   -339.811646f, 78.062561f,    3.505660f   },
    {   74.111252f,    -291.870209f, 87.242966f,    3.140450f   },
    {   47.704395f,    -257.492218f, 74.805099f,    3.317164f   },
    {   -38.511723f,   -384.007477f, 81.393066f,    1.993747f   },
    {   7.879293f,     -380.998199f, 70.764465f,    2.252934f   },
    {   28.118147f,    -482.117249f, 107.030411f,   1.440052f   },
    {   -155.354630f,  -355.248718f, 126.975021f,   2.131143f   },//volcano
};

Position const Talon[8] =
{
    { 8.171189f, -281.296082f, 52.445755f, 3.167837f },     // N
    { -24.869804f, -327.669952f, 52.990738f, 1.844441f },   // NE
    { -59.934452f, -331.398376f, 55.737675f, 1.204341f },   // E
    { -86.656090f, -311.018524f, 60.151081f, 0.642781f },   // SE
    { -90.620819f, -275.878418f, 55.195007f, 6.234818f },   // S
    { -69.726067f, -236.671616f, 56.313885f, 5.406217f },   // SW
    { -34.537041f, -222.452560f, 55.315895f, 4.766120f },   // W
    { -0.510485f, -230.284790f, 57.598892f, 3.961092f }     // NW
};
...
const G3D::Vector3 Initiate_Path_N[]
{ 
    {-30.274246f,   -287.273773f,   220.f   },    // TOP
    { -90.620819f,  -275.878418f,   190.f   },    // S
    { -69.726067f,  -236.671616f,   160.f   },    // SW
    { -34.537041f,  -222.452560f,   130.f   },    // W
    { -0.510485f,   -230.284790f,   100.f    },    // NW
};

const G3D::Vector3 Initiate_Path_NE[]
{
    {-30.274246f,   -287.273773f,   220.f   },    // TOP
    { -69.726067f,  -236.671616f,   190.f   },    // SW
    { -34.537041f,  -222.452560f,   160.f   },    // W
    { -0.510485f,   -230.284790f,   130.f   },    // NW
    { 8.171189f,    -281.296082f,   100.f    },    // N
};
const G3D::Vector3 Initiate_Path_E[]
{
    {-30.274246f,   -287.273773f,   220.f    },    // TOP
    { -34.537041f,  -222.452560f,   190.f    },    // W
    { -0.510485f,   -230.284790f,   160.f    },    // NW
    { 8.171189f,    -281.296082f,   130.f    },    // N
    { -24.869804f,  -327.669952f,   100.f     },    // NE
};
const G3D::Vector3 Initiate_Path_SE[]
{
    { -30.274246f,   -287.273773f,   220.f   },    // TOP
    { -0.510485f,   -230.284790f,   190.f    },    // NW
    { 8.171189f,    -281.296082f,   160.f    },    // N
    { -24.869804f,  -327.669952f,   130.f    },    // NE
    { -59.934452f,  -331.398376f,   100.f     },    // E
};
const G3D::Vector3 Initiate_Path_S[]
{
    { -30.274246f,  -287.273773f,   220.f    },    // TOP
    { 8.171189f,    -281.296082f,   190.f    },    // N
    { -24.869804f,  -327.669952f,   160.f    },    // NE
    { -59.934452f,  -331.398376f,   130.f    },    // E
    { -86.656090f,  -311.018524f,   100.f     },    // SE
};
const G3D::Vector3 Initiate_Path_SW[]
{
    {-30.274246f,   -287.273773f,   220.f    },    // TOP
    { -24.869804f,  -327.669952f,   190.f    },    // NE
    { -59.934452f,  -331.398376f,   160.f    },    // E
    { -86.656090f,  -311.018524f,   130.f    },    // SE
    { -90.620819f,  -275.878418f,   100.f     },    // S
};
const G3D::Vector3 Initiate_Path_W[]
{
    { -30.274246f,  -287.273773f,   220.f    },    // TOP
    { -59.934452f,  -331.398376f,   190.f    },    // E
    { -86.656090f,  -311.018524f,   160.f    },    // SE
    { -90.620819f,  -275.878418f,   130.f    },    // S
    { -69.726067f,  -236.671616f,   100.f     },    // SW
};
const G3D::Vector3 Initiate_Path_NW[]
{
    { -30.274246f,   -287.273773f,  220.f    },    // TOP
    { -86.656090f,  -311.018524f,   190.f    },    // SE
    { -90.620819f,  -275.878418f,   160.f    },    // S
    { -69.726067f,  -236.671616f,   130.f    },    // SW
    { -34.537041f,  -222.452560f,   100.f     },    // W
};
...
public:
    ...
    struct boss_alysrazorAI: public BossAI
    {
        ...
        {
            /*
                Alternate between two spawn groups:
                - 1 ring - 1 explosion
                - 3 explosions
            */

            Position ring_1     { *me };
            Position explosion_1{ *me };
            Position explosion_2{ *me };
            Position explosion_3{ *me };

            if (ring)
            {
                //TC_LOG_ERROR("sql.sql", "summoning ring.");
                /*
                    Move all spawns behind the bird
                */
                me->MovePosition(ring_1, 3.f, me->NormalizeOrientation(me->GetOrientation() + M_PI), true);
                me->MovePosition(explosion_1, 3.f, me->NormalizeOrientation(me->GetOrientation() + M_PI), true);

                /*
                    Here we will set the ring to a random position (top, bottom, left, right) while also setting the incindiary cloud opposite of it.
                */
                uint32 ring_position{ urand(0, 3) };
                switch (ring_position)
                {
                case 0:
                    ring_1.m_positionZ = me->GetPositionZ();
                    explosion_1.m_positionZ = me->GetPositionZ();
                    ring_1.m_positionZ      += 8.f;
                    explosion_1.m_positionZ -= 8.f;
                    break;
                case 1:
                    ring_1.m_positionZ = me->GetPositionZ();
                    explosion_1.m_positionZ = me->GetPositionZ();
                    ...
                    break;
                case 2:
                    me->MovePosition(ring_1, 8.f, me->GetOrientation() + (M_PI / 2), true);
                    me->MovePosition(explosion_1, 8.f, me->GetOrientation() - (M_PI / 2), true);
                    ring_1.m_positionZ = me->GetPositionZ();
                    explosion_1.m_positionZ = me->GetPositionZ();
                    break;
                case 3:
                ...
                /*
                ring_1.m_positionZ += me->GetHoverOffset();
                explosion_1.m_positionZ += me->GetHoverOffset();
                explosion_2.m_positionZ += me->GetHoverOffset();
                explosion_3.m_positionZ += me->GetHoverOffset();
                */

                me->SummonCreature(NPC_BLAZING_POWER, ring_1, TEMPSUMMON_TIMED_DESPAWN, 4500);
                me->SummonCreature(NPC_INCENDIARY_CLOUD, explosion_1, TEMPSUMMON_TIMED_DESPAWN, 3000);
                ring = false;

                //TC_LOG_ERROR("sql.sql", "summoning ring at %u rather than %u", uint32(double(ring_1.m_positionZ)), uint32(double(me->GetPositionZ())));
            }
            else
            {
                ...
                */
                me->MovePosition(explosion_1, 3.f, me->NormalizeOrientation(me->GetOrientation() + M_PI), true);
                me->MovePosition(explosion_2, 3.f, me->NormalizeOrientation(me->GetOrientation() + M_PI), true);
                me->MovePosition(explosion_3, 3.f, me->NormalizeOrientation(me->GetOrientation() + M_PI), true);
                /*
                    Move Spawns up or down.
                */

                /*
                    Move spawns 2 and 3 left or right.
                */
                me->MovePosition(explosion_2, 10.f, me->NormalizeOrientation(me->GetOrientation() + M_PI / 2), true);
                me->MovePosition(explosion_3, 10.f, me->NormalizeOrientation(me->GetOrientation() - M_PI / 2), true);


                explosion_1.m_positionZ = me->GetPositionZ();
                explosion_2.m_positionZ = me->GetPositionZ();
                explosion_3.m_positionZ = me->GetPositionZ();

                explosion_1.m_positionZ += RAND(-12.f, 12.f);
                explosion_2.m_positionZ += RAND(-5.f, 5.f);
                explosion_3.m_positionZ += RAND(-5.f, 5.f);

                me->SummonCreature(NPC_INCENDIARY_CLOUD, explosion_1, TEMPSUMMON_TIMED_DESPAWN, 3000);
                me->SummonCreature(NPC_INCENDIARY_CLOUD, explosion_2, TEMPSUMMON_TIMED_DESPAWN, 3000);
                me->SummonCreature(NPC_INCENDIARY_CLOUD, explosion_3, TEMPSUMMON_TIMED_DESPAWN, 3000);
                ring = true;
            }
        }
        ...
        bool checkWipe()
        {
            auto players = me->GetPlayersInRange(300.f, true);
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_START_ENCOUNTER:
                        ...
                        events.ScheduleEvent(EVENT_SUMMON_TALON, 2000, GROUP_GROUND);
                        events.ScheduleEvent(EVENT_CHECK_DESPAWN, 5000);
                        if (IsHeroic())
                        {
                    ...
                    case EVENT_BLAZING_POWER:
                        if (events.IsInPhase(PHASE_AIR) && !me->HasAura(SPELL_MOLTING_AURA) && me->GetPositionZ() >= 90.0f)
                            SummonAirNPCs();
                        events.ScheduleEvent(EVENT_BLAZING_POWER, 5000);
                        break;
                    ...
                    case EVENT_MOVE_AROUND_PLATFORM:
                        me->GetMotionMaster()->MoveAroundPoint(FallPos[0], 50.0f, false, 50, 135.322f, true);
                        break;
                    ...
                    {
                        if (auto c = me->SummonCreature(NPC_BLAZING_TALON_INITIATE,
                            Talon_spawns[NextTalon].GetPositionX(),
                            Talon_spawns[NextTalon].GetPositionY(),
                            Talon_spawns[NextTalon].GetPositionZ(),
                            Talon_spawns[NextTalon].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 1000))
                            c->AI()->DoAction(uint32(NextTalon + 1));

                        if (auto c2 = me->SummonCreature(NPC_BLAZING_TALON_INITIATE, 
                            Talon_spawns[NextTalon + 4].GetPositionX(),
                            Talon_spawns[NextTalon + 4].GetPositionY(),
                            Talon_spawns[NextTalon + 4].GetPositionZ(),
                            Talon_spawns[NextTalon + 4].GetOrientation(),
                            TEMPSUMMON_CORPSE_TIMED_DESPAWN, 1000))
                            c2->AI()->DoAction(uint32(NextTalon + 5));
                    ...
                    case EVENT_HEROIC_FIRESTORM:
                    {
                        ...
                        for (auto itr =meteorCol.begin(); itr != meteorCol.end(); ++itr)
                    ...
                    case EVENT_MOVE_TORNADOS:
                    {
                        ...
                        me->GetMotionMaster()->MoveAroundPoint(FallPos[0], 50.0f, false, 100,125.322f, true);
                        events.ScheduleEvent(EVENT_HARSH_WINDS, 2000);
                        break;
                    }
...
public:
    ...
    struct npc_plumb_lava_wormAI : public ScriptedAI
    {
        ...
        {
            me->SetReactState(REACT_PASSIVE);
            events.ScheduleEvent(EVENT_LAVA_SPEW, 3000, GROUP_GROUND);
            events.ScheduleEvent(EVENT_TURN, 3000, GROUP_GROUND);
            started = true;

            std::list<Creature*> list_of_npcs;
            GetCreatureListWithEntryInGrid(list_of_npcs, me, me->GetEntry(), 5.0f);
            if (list_of_npcs.size())
                for (auto itr = list_of_npcs.begin(); itr != list_of_npcs.end();)
                    if (auto t = (*itr))
                        if (t->GetGUID() == me->GetGUID())//filter condition
                        {
...
public:
    ...
    struct npc_blazing_talonAI : public ScriptedAI
    {
        ...
        void IsSummonedBy(Unit* summoner) override
        {
            ...
            me->SetDisableGravity(true);
            me->SetHover(true);
            me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_ATTACKABLE_1);
        }
        ...
        void EnterCombat(Unit* /*unit*/) override
        {
            ...
            if (!canUseShield)
            {
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_ATTACKABLE_1);
                canUseShield = true;
                me->SetReactState(REACT_AGGRESSIVE);
                ...
                Talk(YELL_INITIATE);
                events.ScheduleEvent(EVENT_START_COMBAT, 1);
            }
            */
        }
        ...
        {
            //TC_LOG_ERROR("sql.sql", "BT: Movement Inform %u %u", type, point);
            if (type == SPLINE_MOTION_TYPE)
            {
                if (point == 4)
                    me->GetMotionMaster()->MoveLand(1, Talon[waypoint]);
            }
            else
            ...
            switch (point)
            {
                case 1:
                    if (!canUseShield)
                    {
                        ...
                        canUseShield = true;
                        me->SetReactState(REACT_AGGRESSIVE);
                        DoCast(me, urand(0, 1) == 0 ? SPELL_FIREHAWK_TRANSFORM_M : SPELL_FIREHAWK_TRANSFORM_F, true);
                        me->GetMotionMaster()->MoveFall();
        ...
        {
            //TC_LOG_ERROR("sql.sql", "BT: Doaction %u", action);
            switch (action)
            {
            case 1:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_N, 5, 35.f);
                waypoint = (action - 1);
                break;
            case 2:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_NE, 5, 35.f);
                waypoint = (action - 1);
                break;
            case 3:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_E, 5, 35.f);
                waypoint = (action - 1);
                break;
            case 4:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_SE, 5, 35.f);
                waypoint = (action - 1);
                break;
            case 5:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_S, 5, 35.f);
                waypoint = (action - 1);
                break;
            case 6:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_SW, 5, 35.f);
                waypoint = (action - 1);
                break;
            case 7:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_W, 5, 35.f);
                waypoint = (action - 1);
                break;
            case 8:
                me->GetMotionMaster()->MoveSmoothPath(Initiate_Path_NW, 5, 35.f);
                waypoint = (action - 1);
                break;
            case ACTION_FIRESTORM:
                me->CastStop();
                me->ClearUnitState(UNIT_STATE_CASTING);
                DoCast(me, SPELL_BLAZING_SHIELD, true);
                break;
            default:
                TC_LOG_ERROR("sql.sql", "blazing talon initiate received invalid action: %u", action);
                break;
            }
        }
            ...
            if (uint32 eventId = events.ExecuteEvent())
                switch (eventId)
                {
                    ...
                    case EVENT_START_FIEROBLAST:
                        if (me->HasUnitState(UNIT_STATE_CASTING) || me->HasAura(SPELL_BLAZING_SHIELD)) events.ScheduleEvent(eventId, 500);
                        else
                        {
                            if (urand(0, 1) == 1)
                            {
                            ...
                            events.ScheduleEvent(EVENT_START_FIEROBLAST, 1000);
                        }
                        break;
                }
        }
...
public:
    ...
    struct npc_fiery_tornadoAI : public ScriptedAI
    {
        ...
        void IsSummonedBy(Unit* summoner) override
        {
            ...
            me->AddAura(SPELL_FIERY_TORNADO_AURA, me);
        }
            ...
            if (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_MOVE_AROUND_POINT:
                    {
                        ...
                        me->GetMotionMaster()->MoveAroundPoint(center, ray, (bool)numb, 254, 0.0f, true);
                        break;
                    }
                }
            }
...
public:
    ...
    struct npc_majordomo_alysAI : public ScriptedAI
    {
        npc_majordomo_alysAI(Creature* c) : ScriptedAI(c)
        {
            ...
            if (me->isDead())
                if (!me->FindNearestCreature(BOSS_ALYSRAZOR, 500.f, true))
                {
                    me->DespawnCreaturesInArea(NPC_MOLTEN_FEATHER, 200.f);
                    me->SummonCreature(NPC_MOLTEN_FEATHER, Feather[0], TEMPSUMMON_MANUAL_DESPAWN);
                }
        }
...
public:
    ...
    struct npc_egg_pileAI : public CreatureAI
    {
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            for (auto itr = eggs.begin(); itr != eggs.end(); ++itr)

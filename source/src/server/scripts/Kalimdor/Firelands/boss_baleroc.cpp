...
enum Emotes
{
    ...
    SAY_KILL                            = 4,
    SAY_ENRAGE                          = 5,
    SAY_ENRAGE_SPELLWARNING             = 6,
    SAY_JUST_DIED                       = 7,
    SAY_INFERNO_BLADE_SPELLWARNING      = 8,
    SAY_DECIMATION_BLADE_SPELLWARNING   = 9
};
...
public:
    ...
    struct boss_balerocAI : public BossAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_UNLOCK_YELLSPAM, 4000);
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_INFERNO_BLADE:
                        ...
                        Talk(SAY_INFERNO_BLADE);
                        Talk(SAY_INFERNO_BLADE_SPELLWARNING);
                    ...
                    case EVENT_BLADE:
                        ...
                        case 2:
                            ...
                            Talk(SAY_DECIMATION_BLADE);
                            Talk(SAY_DECIMATION_BLADE_SPELLWARNING);
                            break;
                        }
                        events.ScheduleEvent(EVENT_BLADE, 47 * IN_MILLISECONDS);
                        break;

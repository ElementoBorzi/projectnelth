    ...
    public:
        ...
        struct instance_firelands_InstanceMapScript : public InstanceScript
        {
            ...
            void Initialize() override
            {
                ...
                COT_teleporter_one = 0;
                COT_teleporter_two = 0;
            }
            ...
            void OnGameObjectCreate(GameObject* go) override
            {
                switch (go->GetEntry())
                {
                case GO_CIRCLE_OF_THORNS_PORTAL_1:
                    COT_teleporter_one = go->GetGUID();
                    ...
                    break;
                case GO_CIRCLE_OF_THORNS_PORTAL_2:
                    COT_teleporter_two = 0;
                    if (IsDone(DATA_BALOROC) && IsDone(DATA_SHANNOX) && IsDone(DATA_LORD_RHYOLITH) && IsDone(DATA_BETHTILAC) && IsDone(DATA_ALYSRAZOR))
                        go->RemoveFlag(GAMEOBJECT_FLAGS, GO_FLAG_NOT_SELECTABLE);
                    break;
            ...
            bool ItemDrop(Object* source, LootItem& loot) override
            {
                if (instance->IsHeroic())
                if (auto item_template = sObjectMgr->GetItemTemplate(loot.itemid))
                {
                    
                    switch (item_template->ItemId)
                    {
                    case 71640: loot.itemid = 71641;
                        break;
                    case 71365: loot.itemid = 71561;
                        break;
                    case 70929: loot.itemid = 71563;
                        break;
                    case 71367: loot.itemid = 71564;
                        break;
                    case 68972: loot.itemid = 69113;
                        break;
                    case 68915: loot.itemid = 69109;
                        break;
                    case 71359: loot.itemid = 71560;
                        break;
                    case 71361: loot.itemid = 71557;
                        break;
                    default:
                        return true;
                        break;
                    }
                    //TC_LOG_ERROR("sql.sql", "firelands rare item drop: %u converted into %u", item_template->ItemId, loot.itemid);
                }
                else return false;
        ...
        private:
            ...
            uint64 COT_teleporter_one;
            uint64 COT_teleporter_two;
        };

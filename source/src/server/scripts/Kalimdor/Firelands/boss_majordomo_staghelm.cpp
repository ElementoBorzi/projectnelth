...
class boss_majordomo_staghelm : public CreatureScript
{
    ...
    struct boss_majordomo_staghelmAI : public BossAI
    {
        ...
        void Reset() override
        {
            ...
            me->DespawnCreaturesInArea(NPC_DESTINATION_STALKER, 200.f);
        }
        ...
        void MovementInform(uint32 type, uint32 id) override
        {
            ...
            {
                me->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_UNK_6 | UNIT_FLAG_NOT_ATTACKABLE_1 | UNIT_FLAG_NON_ATTACKABLE);
        ...
        void UpdateAI(const uint32 diff) override
        {
                ...
                && instance->IsDone(DATA_ALYSRAZOR))
            {
                ...
                me->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_IMMUNE_TO_NPC | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_UNK_6 | UNIT_FLAG_NOT_ATTACKABLE_1 | UNIT_FLAG_NON_ATTACKABLE);
                me->GetMotionMaster()->MovePoint(me->GetEntry(), 520.879f, -61.858f, 83.947f);
...
class npc_burning_orb : public CreatureScript //53216
{
    ...
    struct npc_burning_orbAI : public ScriptedAI
    {
        ...
        void IsSummonedBy(Unit* summoner) override
        {
            ...
            events.ScheduleEvent(EVENT_ORB_DAMAGE, 1000);
        }

        ...
        struct instance_halls_of_origination_InstanceMapScript : public InstanceScript
        {
            ...
            void OnGameObjectCreate(GameObject* go)
            {
                switch (go->GetEntry())
                {
                    ...
                    case GO_LIFT_OF_THE_MAKER:
                        liftOfMakerGUID = go->GetGUID();
                        break;
                }

                AddObject(go, go->GetEntry(), true);
            }
            ...
            void OnGameObjectRemove(GameObject* go)
            {
                ...
                AddObject(go, go->GetEntry(), false);
            }
            ...
            void OnCreatureCreate(Creature* creature)
            {
                ...
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_VEIL_OF_SKY:
                        ...
                        break;
                    case NPC_LIVING_VINE:
                        creature->AddAura(75864, creature);
            ...
            void OnUnitDeath(Unit* unit)
            {
                ...
                switch (creature->GetEntry())
                {
                    ...
                    case NPC_DUSTBONE_HORROR:
                        ...
                        break;
                    case NPC_LIVING_VINE:
                        if (auto a = creature->GetAura(75864, creature->GetGUID()))
                        {
                            a->SetDuration(8000);
                        ...
                        break;
                    case 40669:
                    case 40585://spore clouds
                        creature->DespawnOrUnsummon(30000);
                        creature->CastWithDelay(100, creature, 75701, true);
                        
                        if (auto c = creature->SummonCreature(144951, *creature))
                        {
                            c->CastWithDelay(100, c, 75701, true);
                            c->AddUnitState(UNIT_STATE_ROOT);
                            c->SetReactState(REACT_PASSIVE);
                            c->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_ATTACKABLE_1 | UNIT_FLAG_NOT_SELECTABLE | UNIT_FLAG_IMMUNE_TO_PC | UNIT_FLAG_IMMUNE_TO_NPC);

...
enum Enums
{
    ...
    SPELL_MARK_OF_THE_WILD_RANK_2 = 24752,
...
public:
    ...
    struct npc_disciple_of_naralexAI : public npc_escortAI
    {
                    ...
                    switch (currentEvent)
                    {
                        ...
                        case TYPE_NARALEX_PART3:
                            ...
                            if (eventProgress == 2)
                            {
                                ...
                                eventTimer = 15000;
                                //CAST_AI(npc_escort::npc_escortAI, me->AI())->SetCanDefend(false);
                                if (auto naralex = instance->instance->GetCreature(instance->GetData64(DATA_NARALEX)))
                            ...
                            if (eventProgress == 3)
                            {
                                ...
                                TempSummon* Temp1 = me->SummonCreature(NPC_DEVIATE_MOCCASIN, 113.096558f, 272.534119f, -100.618973f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp2 = me->SummonCreature(NPC_DEVIATE_MOCCASIN, 137.223053f, 255.291199f, -100.677254f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp3 = me->SummonCreature(NPC_DEVIATE_MOCCASIN, 141.468750f, 225.270142f, -101.085747f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                Temp1->AI()->AttackStart(me);
                                Temp2->AI()->AttackStart(me);
                                Temp3->AI()->AttackStart(me);
                            }
                            else
                            if (eventProgress == 4)
                            {
                                ...
                                TempSummon* Temp1 = me->SummonCreature(NPC_NIGHTMARE_ECTOPLASM, 104.125977f, 269.258972f, -100.947937f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp2 = me->SummonCreature(NPC_NIGHTMARE_ECTOPLASM, 119.041367f, 270.071411f, -100.971535f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp3 = me->SummonCreature(NPC_NIGHTMARE_ECTOPLASM, 130.611771f, 263.467804f, -100.922188f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp4 = me->SummonCreature(NPC_NIGHTMARE_ECTOPLASM, 145.440964f, 246.223679f, -100.727364f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp5 = me->SummonCreature(NPC_NIGHTMARE_ECTOPLASM, 130.041092f, 215.934906f, -101.182236f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp6 = me->SummonCreature(NPC_NIGHTMARE_ECTOPLASM, 147.425415f, 234.953140f, -100.919640f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                TempSummon* Temp7 = me->SummonCreature(NPC_NIGHTMARE_ECTOPLASM, 130.041092f, 215.934906f, -101.182236f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 15000);
                                Temp1->AI()->AttackStart(me);
                                Temp2->AI()->AttackStart(me);
                                Temp3->AI()->AttackStart(me);
                                Temp4->AI()->AttackStart(me);
                                Temp5->AI()->AttackStart(me);
                                Temp6->AI()->AttackStart(me);
                                Temp7->AI()->AttackStart(me);
                            }
                            else
                            if (eventProgress == 5)
                            {
                                ...
                                TempSummon* Mutanus = me->SummonCreature(NPC_MUTANUS_THE_DEVOURER, 130.811941f, 263.121796f, -100.733299f, 0, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 300000);
                                Mutanus->AI()->AttackStart(me);
        ...
        private:
            Position NaralexPosition = { 112.573708, 236.106522, -96.206848, 4.399027 };
    };

...
public:
    ...
    struct npc_time_riftAI : public ScriptedAI
    {
        ...
        void DoSummonAtRift(uint32 creature_entry)
        {
            ...
            if (auto Summon = DoSummon(creature_entry, pos, 30000, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT))
                if (auto temp = Unit::GetUnit(*me, instance ? instance->GetData64(DATA_MEDIVH) : 0))

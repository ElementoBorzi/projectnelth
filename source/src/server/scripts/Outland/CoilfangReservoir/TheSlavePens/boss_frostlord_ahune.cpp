    ...
    public:
        ...
        struct npc_frostlord_ahuneAI : public Scripted_NoMovementAI
        {
            ...
            void Reset()
            {
                ...
                me->SummonGameObject(GO_ICE_STONE, -69.94f, -162.244f, -2.36f, 0, 0, 0, 0, 0, 0);
            }
            ...
            void JustSummoned(Creature* summon)
            {
                switch (summon->GetEntry())
                {
                    case NPC_FROZEN_CORE:
                        ...
                        summon->SetMaxHealth(me->GetHealth());
            ...
            void JustDied(Unit* /*who*/)
            {
                ...
                me->SummonGameObject(GO_SNOW_PILE, -97.095f, -203.866f, -1.191f, 1.5f, 0, 0, 0, 0, 0);
                _summons.DespawnAll();
                Map* map = me->GetMap();

...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "creature",       SEC_CONSOLE,      false, &HandleGoCreatureCommand,          "" },
            { "graveyard",      SEC_CONSOLE,      false, &HandleGoGraveyardCommand,         "" },
            { "grid",           SEC_CONSOLE,      false, &HandleGoGridCommand,              "" },
            { "object",         SEC_CONSOLE,      false, &HandleGoObjectCommand,            "" },
            { "taxinode",       SEC_CONSOLE,      false, &HandleGoTaxinodeCommand,          "" },
            { "trigger",        SEC_CONSOLE,      false, &HandleGoTriggerCommand,           "" },
            { "zonexy",         SEC_CONSOLE,      false, &HandleGoZoneXYCommand,            "" },
            { "xyz",            SEC_CONSOLE,      false, &HandleGoXYZCommand,               "" },
            { "ticket",         SEC_CONSOLE,      false, &HandleGoTicketCommand,            "" },
            { "",               SEC_CONSOLE,      false, &HandleGoXYZCommand,               "" },
        };

        static std::vector<ChatCommand> commandTable =
        {
            { "go",             SEC_CONSOLE,      false, NULL,                     "", goCommandTable },
        };
        return commandTable;
    }
    ...
    */
    ...
    static bool HandleGoCreatureCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (auto creature = sObjectAccessor->GetCreature(*player, MAKE_NEW_GUID(guid, id, HIGHGUID_UNIT)))
        {

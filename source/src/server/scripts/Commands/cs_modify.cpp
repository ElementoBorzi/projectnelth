...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "fly",            SEC_CONSOLE,      false, &HandleModifyFlyCommand,           "" },
            { "all",            SEC_CONSOLE,      false, &HandleModifyASpeedCommand,        "" },
            { "walk",           SEC_CONSOLE,      false, &HandleModifySpeedCommand,         "" },
            { "backwalk",       SEC_CONSOLE,      false, &HandleModifyBWalkCommand,         "" },
            { "swim",           SEC_CONSOLE,      false, &HandleModifySwimCommand,          "" },
            { "",               SEC_CONSOLE,      false, &HandleModifyASpeedCommand,        "" },
        };
        static std::vector<ChatCommand> modifyCommandTable =
        {
            { "hp",             SEC_CONSOLE,      false, &HandleModifyHPCommand,            "" },
            { "mana",           SEC_CONSOLE,      false, &HandleModifyManaCommand,          "" },
            { "rage",           SEC_CONSOLE,      false, &HandleModifyRageCommand,          "" },
            { "runicpower",     SEC_CONSOLE,      false, &HandleModifyRunicPowerCommand,    "" },
            { "energy",         SEC_CONSOLE,      false, &HandleModifyEnergyCommand,        "" },
            { "money",          SEC_CONSOLE,      false, &HandleModifyMoneyCommand,         "" },
            { "scale",          SEC_CONSOLE,      false, &HandleModifyScaleCommand,         "" },
            { "bit",            SEC_CONSOLE,      false, &HandleModifyBitCommand,           "" },
            { "faction",        SEC_CONSOLE,      false, &HandleModifyFactionCommand,       "" },
            { "spell",          SEC_CONSOLE,      false, &HandleModifySpellCommand,         "" },
            { "talentpoints",   SEC_CONSOLE,      false, &HandleModifyTalentCommand,        "" },
            { "mount",          SEC_CONSOLE,      false, &HandleModifyMountCommand,         "" },
            { "honor",          SEC_CONSOLE,      false, &HandleModifyHonorCommand,         "" },
            { "reputation",     SEC_CONSOLE,     false, &HandleModifyRepCommand,           "" },
            { "drunk",          SEC_CONSOLE,      false, &HandleModifyDrunkCommand,         "" },
            { "standstate",     SEC_CONSOLE,     false, &HandleModifyStandStateCommand,    "" },
            { "phase",          SEC_CONSOLE,  false, &HandleModifyPhaseCommand,         "" },
            { "gender",         SEC_CONSOLE,     false, &HandleModifyGenderCommand,        "" },
            { "currency",       SEC_CONSOLE,     false, &HandleModifyCurrencyCommand,      "" },
            { "speed",          SEC_CONSOLE,      false, NULL,           "", modifyspeedCommandTable },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "morph",          SEC_CONSOLE,     false, &HandleModifyMorphCommand,          "" },
            { "demorph",        SEC_CONSOLE,     false, &HandleDeMorphCommand,              "" },
            { "modify",         SEC_CONSOLE,      false, NULL,                 "", modifyCommandTable },
        };
        return commandTable;
    }
    ...
    static bool HandleModifyASpeedCommand(ChatHandler* handler, const char* args)
    {
        ...
        target->SetSkipOnePacketForASH(true); //prevent false positives when modding your speed as a gm or tester
        return true;
    }
...
//demorph player or unit
    ...
    static bool HandleModifyCurrencyCommand(ChatHandler* handler, const char* args)
    {
        ...
        char const* currencyStr = strtok((char*)args, " ");
        if (!currencyStr)
            return false;

        uint32 currencyId = atoi(currencyStr);

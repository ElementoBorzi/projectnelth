...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "append",         SEC_CONSOLE,      true,  &HandleGMTicketResponseAppendCommand,    "" },
            { "appendln",       SEC_CONSOLE,      true,  &HandleGMTicketResponseAppendLnCommand,  "" },
        };
        static std::vector<ChatCommand> ticketCommandTable =
        {
            { "assign",         SEC_CONSOLE,     true,  &HandleGMTicketAssignToCommand,          "" },
            { "close",          SEC_CONSOLE,      true,  &HandleGMTicketCloseByIdCommand,         "" },
            { "closedlist",     SEC_CONSOLE,      true,  &HandleGMTicketListClosedCommand,        "" },
            { "comment",        SEC_CONSOLE,      true,  &HandleGMTicketCommentCommand,           "" },
            { "complete",       SEC_CONSOLE,      true,  &HandleGMTicketCompleteCommand,          "" },
            { "delete",         SEC_CONSOLE,  true,  &HandleGMTicketDeleteByIdCommand,        "" },
            { "escalate",       SEC_CONSOLE,      true,  &HandleGMTicketEscalateCommand,          "" },
            { "escalatedlist",  SEC_CONSOLE,     true,  &HandleGMTicketListEscalatedCommand,     "" },
            { "list",           SEC_CONSOLE,      true,  &HandleGMTicketListCommand,              "" },
            { "onlinelist",     SEC_CONSOLE,      true,  &HandleGMTicketListOnlineCommand,        "" },
            { "reset",          SEC_CONSOLE,  true,  &HandleGMTicketResetCommand,             "" },
            { "response",       SEC_CONSOLE,      true,  NULL,                                    "", ticketResponseCommandTable },
            { "togglesystem",   SEC_CONSOLE,  true,  &HandleToggleGMTicketSystem,             "" },
            { "unassign",       SEC_CONSOLE,     true,  &HandleGMTicketUnAssignCommand,          "" },
            { "viewid",         SEC_CONSOLE,      true,  &HandleGMTicketGetByIdCommand,           "" },
            { "viewname",       SEC_CONSOLE,      true,  &HandleGMTicketGetByNameCommand,         "" },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "ticket",         SEC_CONSOLE,      false, NULL,                                    "", ticketCommandTable },
        };
        return commandTable;
    }

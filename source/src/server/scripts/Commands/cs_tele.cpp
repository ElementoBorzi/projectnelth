...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            { "add",            SEC_CONSOLE,  false, &HandleTeleAddCommand,             "" },
            { "del",            SEC_CONSOLE,  true,  &HandleTeleDelCommand,             "" },
            { "name",           SEC_CONSOLE,      true,  &HandleTeleNameCommand,            "" },
            { "group",          SEC_CONSOLE,      false, &HandleTeleGroupCommand,           "" },
            { "",               SEC_CONSOLE,      false, &HandleTeleCommand,                "" },
        };
        static std::vector<ChatCommand> commandTable =
        {
            { "tele",           SEC_CONSOLE,      false, NULL,                   "", teleCommandTable },
            { "firelands",      SEC_CONSOLE,      false, &HandleFirelandCommand, "" },
        };
        return commandTable;
    }
    ...
    static bool HandleFirelandCommand(ChatHandler* handler, const char* /*args*/)
    {
        Player* me = handler->GetSession()->GetPlayer();
        ...
        me->TeleportTo(720, -537.502f, 314.923f, 115.499f, 5.967f);
        return true;
    }
};

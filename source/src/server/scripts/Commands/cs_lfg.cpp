...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        {
            {  "player",     SEC_CONSOLE, false, &HandleLfgPlayerInfoCommand, "" },
            {   "group",     SEC_CONSOLE, false,  &HandleLfgGroupInfoCommand, "" },
            {   "queue",     SEC_CONSOLE, false,  &HandleLfgQueueInfoCommand, "" },
            {   "clean",  SEC_CONSOLE, false,      &HandleLfgCleanCommand, "" },
            { "options",  SEC_CONSOLE, false,    &HandleLfgOptionsCommand, "" },
        };

        static std::vector<ChatCommand> commandTable =
        {
            {       "lfg",   SEC_CONSOLE, false,                        NULL, "", lfgCommandTable },
        };
        return commandTable;
    }

...
public:
    ...
    struct npc_amani_lynxAI : public ScriptedAI
    {
        npc_amani_lynxAI(Creature* creature) : ScriptedAI(creature)
        {
        }

        void Reset()
        {
            me->CastSpell(me, 5215, true);
        }
    };
...
class spell_Domesticate : public SpellScriptLoader
{
public:
    spell_Domesticate() : SpellScriptLoader("spell_Domesticate") { }
    class spell_Domesticate_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_Domesticate_AuraScript);
        ...
        void Register()
        {
            OnEffectRemove += AuraEffectRemoveFn(spell_Domesticate_AuraScript::HandleOnEffectRemove, EFFECT_0, SPELL_AURA_MOD_CHARM, AURA_EFFECT_HANDLE_REAL);
        }
    };
    AuraScript* GetAuraScript() const
    {
        return new spell_Domesticate_AuraScript();
    }
};

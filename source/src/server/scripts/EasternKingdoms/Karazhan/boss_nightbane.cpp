...
static const Position IntroWay[8] =
{
    {-11053.37f, -1794.48f, 149.00f, 0.0f},
    {-11141.07f, -1841.40f, 125.00f, 0.0f},
    {-11187.28f, -1890.23f, 125.00f, 0.0f},
    {-11189.20f, -1931.25f, 125.00f, 0.0f},
    {-11153.76f, -1948.93f, 125.00f, 0.0f},
    {-11128.73f, -1929.75f, 125.00f, 0.0f},
    {-11140.00f, -1915.00f, 122.00f, 0.0f},
    {-11163.00f, -1903.00f, 91.473f, 0.0f}
};

#define POINT_INTRO 42
...
public:
    ...
    struct boss_nightbaneAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (!Intro)
            {
                me->SetHomePosition(IntroWay[7].m_positionX, IntroWay[7].m_positionY, IntroWay[7].m_positionZ, IntroWay[7].m_orientation);
                me->GetMotionMaster()->MovePoint(POINT_INTRO, IntroWay[7]);
            }
        }
        ...
        void TakeOff()
        {
            ...
            (*me).GetMotionMaster()->MovePoint(0, IntroWay[2].m_positionX, IntroWay[2].m_positionY, IntroWay[2].m_positionZ);
            ...
            */
            ...
            if (Phase == 2)
            {
                ...
                if (FlyTimer <= diff) //landing
                {
                    ...
                    me->GetMotionMaster()->Clear(false);
                    me->GetMotionMaster()->MovePoint(3, IntroWay[3].m_positionX, IntroWay[3].m_positionY, IntroWay[3].m_positionZ);

...
class spell_alizabel_blade_dance : public SpellScriptLoader
{
public:
    spell_alizabel_blade_dance() : SpellScriptLoader("spell_alizabel_blade_dance") { }
    /*
        REPLACE INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES ('104995', 'spell_alizabel_blade_dance');
        REPLACE INTO `spell_script_names` (`spell_id`, `ScriptName`) VALUES ('104994', 'spell_alizabel_blade_dance');
    */
    class spell_alizabel_blade_dance_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_alizabel_blade_dance_SpellScript);

        SpellCastResult CheckCast()
        {
            if (auto c = GetCaster())
                if (!c->HasAura(SPELL_BLADE_DANCE_AURA))
        ...
        void Register()
        {
            OnCheckCast += SpellCheckCastFn(spell_alizabel_blade_dance_SpellScript::CheckCast);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_alizabel_blade_dance_SpellScript();
    }
};
...
void AddSC_boss_alizabal()
{
    ...
    new spell_alizabel_blade_dance();
}

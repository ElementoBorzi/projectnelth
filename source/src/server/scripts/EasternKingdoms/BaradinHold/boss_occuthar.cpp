    ...
    struct boss_occutharAI : public BossAI
    {
        ...
        void JustSummoned(Creature* summon)
        {
            ...
            if (summon->GetEntry() == NPC_FOCUS_FIRE_DUMMY)
            {
                ...
                summon->CastWithDelay(500, summon, 97212, true);
                summon->CastWithDelay(1500, summon, 97212, true);
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_FOCUSED_FIRE:
                        ...
                        events.ScheduleEvent(EVENT_EYE_OF_OCCUTHAR, 16000);
                        break;
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_EYE_EXPLOSION:
                        ...
                        events.ScheduleEvent(EVENT_EYE_GO_INVIS, 500);
                        break;

                    case EVENT_EYE_GO_INVIS:

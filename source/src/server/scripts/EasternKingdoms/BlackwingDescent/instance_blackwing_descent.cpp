...
static const Position AtramedesPos = { 310.065247f, -216.574310f, 47.767349f, 3.237012f };
...
class instance_blackwing_descent : public InstanceMapScript
{
    public:
        ...
        struct instance_blackwing_descent_InstanceMapScript : public InstanceScript
        {
            ...
            void OnGameObjectCreate(GameObject* go)
            {
                switch (go->GetEntry())
                {
                    ...
                    case GO_WING_DOOR:
                        ...
                        break;
                    case GO_NEFARIAN_ELEVATOR://lava
                        go->SetControlableTransport();
                        go->EnableCollision(true);
                        nefarian_elevatorGUID = go->GetGUID();
                        break;
                    case GO_ATRAMEDES_DOOR:
                        atramedes_door_GUID = go->GetGUID();
            ...
            {
                /*
                if (creature->GetEntry() == NPC_NEFARIUS_MALORIAK)
                    TC_LOG_ERROR("sql.sql", "nefarian despawning.");
                */
            }
            ...
            void OnCreatureCreate(Creature* creature)
            {
                ...
                case NPC_CHIMAERON:
                    ...
                    creature->DisableMovementFlagUpdate(false);

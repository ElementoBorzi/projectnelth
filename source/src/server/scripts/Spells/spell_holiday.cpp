...
void AddSC_holiday_spell_scripts()
{
    ...
    new go_romantic_basket();
    new spell_snagglebolts_khorium_bomb();
    // Hallow's End
    ...
    new spell_rocket_slam_slamming();
    new spell_racer_slam_resolve();
    // Mid summer festival
    new spell_torch_target_picker();
    new spell_juggle_torch_catch();

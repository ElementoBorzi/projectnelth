            ...
            void UpdateAI(const uint32 diff)
            {
                if (_rangeCheckTimer <= diff)
                {
                    if (auto xt002 = me->GetCreature(*me, _instance->GetData64(BOSS_XT002)))
                    {
                        ...
                        {
                            xt002->AI()->SetData(DATA_CRAPBOT, 0);
    ...
    public:
        ...
        class spell_xt002_gravity_bomb_damage_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex /*eff*/)
            {
                ...
                if (caster->GetAI())
                    if (caster->GetAI()->GetData(DATA_HARD_MODE) != 0)
...
class spell_xt002_heart_overload_periodic : public SpellScriptLoader
{
    public:
        ...
        class spell_xt002_heart_overload_periodic_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_xt002_heart_overload_periodic_SpellScript::HandleScript, EFFECT_2, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_xt002_hearth_overload : public SpellScriptLoader
{
    public:
        spell_xt002_hearth_overload() : SpellScriptLoader("spell_xt002_hearth_overload") { }

        class spell_xt002_hearth_overload_AuraScript : public AuraScript
        {
            PrepareAuraScript(spell_xt002_hearth_overload_AuraScript);
            ...
            void Register()
            {
                OnEffectPeriodic += AuraEffectPeriodicFn(spell_xt002_hearth_overload_AuraScript::OnPeriodicTick, EFFECT_0, SPELL_AURA_PERIODIC_TRIGGER_SPELL);
            }
        };
...
void AddSC_boss_xt002()
{
    ...
    new spell_xt002_hearth_overload();

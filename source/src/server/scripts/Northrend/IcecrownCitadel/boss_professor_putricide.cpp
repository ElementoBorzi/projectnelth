    ...
    public:
        ...
        struct boss_professor_putricideAI : public BossAI
        {
            ...
            void Reset() override
            {
                ...
                if (instance->IsDone(DATA_ROTFACE) && instance->IsDone(DATA_FESTERGUT))
            ...
            uint32 GetData(uint32 type)  const
            {
                switch (type)
                {
                    ...
                    {
                        // ALSO MODIFIES! set after call to true; use SetData
                    ...
                    case DATA_ABOMINATION:
                        // summons.RemoveNotExisting(); //we should not need this hopefully
    ...
    public:
        ...
        void SpellHitTarget(Unit* /*target*/, SpellInfo const* spell)
        {
            if (!_newTargetSelectTimer && spell->Id == sSpellMgr->GetSpellIdForDifficulty(_hitTargetSpellId, me))
                _newTargetSelectTimer = me->GetEntry() == NPC_GAS_CLOUD ? 500 : 1000;
        }
    ...
    public:
        ...
        class spell_putricide_unstable_experiment_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                ...
                GetCaster()->ToCreature()->AI()->SetData(DATA_EXPERIMENT_STAGE, true);
    ...
    public:
        ...
        class spell_putricide_mutation_init_AuraScript : public AuraScript
        {
            ...
            void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
            {
                ...
                if (GetTarget()->GetMap()->GetSpawnMode() & 1)  // wtf ? XD
                    spellId = 71503;

                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_BLOOD_MIRROR:
                        {
                            ...
                            if (me->getVictim())
                            {
                                ...
                                if (_offtankGuid != (newOfftank ? newOfftank->GetGUID() : 0) || me->getVictim()->GetGUID() != _tankGuid)
                                {
                                    _offtankGuid = (newOfftank ? newOfftank->GetGUID() : 0);
                                    ...
                                    if (newOfftank)
                                    {
                                        ...
                                        if (Item* shadowsEdge = newOfftank->GetWeaponForAttack(BASE_ATTACK, true))
                                            if (!newOfftank->HasAura(SPELL_THIRST_QUENCHED) && shadowsEdge->GetEntry() == ITEM_SHADOW_S_EDGE && !newOfftank->HasAura(SPELL_GUSHING_WOUND))
                                                newOfftank->CastSpell(newOfftank, SPELL_GUSHING_WOUND, true);

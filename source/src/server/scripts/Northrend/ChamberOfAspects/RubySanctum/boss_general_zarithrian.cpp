...
class boss_general_zarithrian : public CreatureScript
{
    public:
        ...
        struct boss_general_zarithrianAI : public BossAI
        {
            ...
            {
                _Reset();
                if (instance->IsDone(DATA_SAVIANA_RAGEFIRE) && instance->IsDone(DATA_BALTHARUS_THE_WARBORN))
            ...
            {
                return (instance->IsDone(DATA_SAVIANA_RAGEFIRE) && instance->IsDone(DATA_BALTHARUS_THE_WARBORN));
            }
            ...
            void UpdateAI(uint32 const diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        {
                            if (auto stalker1 = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_ZARITHRIAN_SPAWN_STALKER_1)))
                                stalker1->CastSpell(stalker1, SPELL_SUMMON_FLAMECALLER, false);

                            if (auto stalker2 = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_ZARITHRIAN_SPAWN_STALKER_2)))
    ...
    public:
        ...
        struct npc_onyx_flamecallerAI : public npc_escortAI
        {
            ...
            void IsSummonedBy(Unit* /*summoner*/)
            {
                ...
                if (auto zarithrian = ObjectAccessor::GetCreature(*me, _instance->GetData64(DATA_GENERAL_ZARITHRIAN)))

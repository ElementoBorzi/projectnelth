...
class spell_drakari_colossus_emerge : public SpellScriptLoader
{
public:
    spell_drakari_colossus_emerge() : SpellScriptLoader("spell_drakari_colossus_emerge") { }

    class spell_drakari_colossus_emerge_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_drakari_colossus_emerge_SpellScript);
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            if (auto caster = GetCaster())
            {
                ...
                caster->SummonCreature(29573, pos);
            }
        }

        void Register()
        {
            OnEffectHit += SpellEffectFn(spell_drakari_colossus_emerge_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
        }
    };

    SpellScript* GetSpellScript() const
    {
        return new spell_drakari_colossus_emerge_SpellScript();
    }
};
...
void AddSC_boss_drakkari_colossus()
{
    ...
    new npc_living_mojo();
    new spell_drakari_colossus_emerge();
}

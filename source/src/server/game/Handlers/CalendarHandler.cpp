...
void WorldSession::HandleCalendarGetCalendar(WorldPacket& /*recvData*/)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_GET_CALENDAR [" UI64FMTD "]", guid);
...
void WorldSession::HandleCalendarGetEvent(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_GET_EVENT. Player ["
...
{
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_GUILD_FILTER [" UI64FMTD "]", _player->GetGUID());
...
{
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_ARENA_TEAM [" UI64FMTD "]", _player->GetGUID());
...
void WorldSession::HandleCalendarUpdateEvent(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_UPDATE_EVENT [" UI64FMTD "] EventId [" UI64FMTD
...
void WorldSession::HandleCalendarCopyEvent(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_COPY_EVENT [" UI64FMTD "], EventId [" UI64FMTD
...
{
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_INVITE");
    ...
    if (_player->GetOTeam() != inviteeTeam && !sWorld->getBoolConfig(CONFIG_ALLOW_TWO_SIDE_INTERACTION_CALENDAR))
    {
...
void WorldSession::HandleCalendarEventSignup(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_SIGNUP [" UI64FMTD "] EventId [" UI64FMTD "] Tentative %u", guid, eventId, tentative);
...
void WorldSession::HandleCalendarEventRsvp(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_RSVP [" UI64FMTD "] EventId ["
...
void WorldSession::HandleCalendarEventRemoveInvite(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_REMOVE_INVITE ["
...
void WorldSession::HandleCalendarEventStatus(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_STATUS [" UI64FMTD "] EventId ["
...
void WorldSession::HandleCalendarEventModeratorStatus(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_EVENT_MODERATOR_STATUS [" UI64FMTD "] EventId ["
        UI64FMTD "] ownerInviteId [" UI64FMTD "], Invitee ([" UI64FMTD "] id: ["
...
void WorldSession::HandleCalendarComplain(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_COMPLAIN [" UI64FMTD "] EventId ["
...
void WorldSession::HandleCalendarGetNumPending(WorldPacket& /*recvData*/)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_CALENDAR_GET_NUM_PENDING: [" UI64FMTD
...
void WorldSession::HandleSetSavedInstanceExtend(WorldPacket& recvData)
{
    ...
    TC_LOG_DEBUG("network.opcode", "CMSG_SET_SAVED_INSTANCE_EXTEND - MapId: %u, Difficulty: %u, ToggleExtend: %s", mapId, difficulty, toggleExtend ? "On" : "Off");
...
{
    TC_LOG_DEBUG("network.opcode", "%s", add ? "SMSG_CALENDAR_RAID_LOCKOUT_ADDED" : "SMSG_CALENDAR_RAID_LOCKOUT_REMOVED");
    time_t currTime = time(NULL);
...
void WorldSession::SendCalendarRaidLockoutUpdated(InstanceSave const* save)
{
    ...
    uint64 guid = _player->GetGUID();
    TC_LOG_DEBUG("network.opcode", "SMSG_CALENDAR_RAID_LOCKOUT_UPDATED [" UI64FMTD

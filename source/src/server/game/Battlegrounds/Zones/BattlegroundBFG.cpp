...
BattlegroundBFG::BattlegroundBFG()
{
    ...
    BgCreatures.resize(BG_BFG_NPC_MAX); // +5 for aura triggers
...
void BattlegroundBFG::AddPlayer(Player* player)
{
    ...
    if (isBattleground() || isRatedBattleground()) {
        if (player->GetTeamId() == TEAM_HORDE)
            player->TeleportTo(761, 1430.620728f, 983.987427f, 0.317268f, 1.588074f, 0);
    }
}
...
void BattlegroundBFG::_NodeOccupied(uint8 node, Team team)
{
    ...
    */
    ...
    if (node == BG_BFG_NODE_LIGHTHOUSE) //eventually, you will want to do a switch for this to work for every base.
        for (uint8 i = BG_BFG_NPC_LH_1; i <= BG_BFG_NPC_LH_19; ++i)
            if (!GetBGCreature(i))
            {
                Creature* newcreature = AddCreature(GetNPCTemplate(team, i),    // either alliance or horde npc
                    BFG_NPC_DATA[i].type,
                    BFG_NPC_DATA[i].team,
                    BFG_NPC_DATA[i].x,
                    BFG_NPC_DATA[i].y,
    ...
    if (node == BG_BFG_NODE_MINE) //eventually, you will want to do a switch for this to work for every base.
        for (uint8 i = BG_BFG_NPC_MINE_1; i <= BG_BFG_NPC_MINE_20; ++i)
            if (!GetBGCreature(i))
            {
                Creature* newcreature = AddCreature(GetNPCTemplate(team, i),    // either alliance or horde npc
                    BFG_NPC_DATA[i].type,
    ...
    if (node == BG_BFG_NODE_WATERWORKS) //eventually, you will want to do a switch for this to work for every base.
        for (uint8 i = BG_BFG_NPC_WW_1; i <= BG_BFG_NPC_WW_17; ++i)
            if (!GetBGCreature(i))
            {
                Creature* newcreature = AddCreature(GetNPCTemplate(team, i),    // either alliance or horde npc
                    BFG_NPC_DATA[i].type,
...
uint32 BattlegroundBFG::GetNPCTemplate(Team team, int8 type)
{
    switch (type)
    {
    case BG_BFG_NPC_LH_1:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_2:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_3:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_4:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_5:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_6:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_7:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_8:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_9:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_10:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_LH_11:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_12:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_LH_13:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_14:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_LH_15:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_LH_16:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_17:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_18:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_LH_19:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
        // Waterworks
    case BG_BFG_NPC_WW_1:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_2:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_3:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_4:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_5:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_6:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_7:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_WW_8:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_9:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_WW_10:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_11:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_12:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_WW_13:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_14:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_15:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_WW_16:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_WW_17:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
        // Mines
    case BG_BFG_NPC_MINE_1:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_MINE_2:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_3:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_MINE_4:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_5:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_6:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_7:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_8:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_9:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_10:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_11:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_12:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_13:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_14:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_15:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_16:
        return (team == ALLIANCE ? NPC_WORGEN_MISC : NPC_PLAGUEBEARER_MISC);
        break;
    case BG_BFG_NPC_MINE_17:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_18:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_19:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    case BG_BFG_NPC_MINE_20:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
        break;
    default:
        return (team == ALLIANCE ? NPC_HUMAN_MISC : NPC_UNDEAD_MISC);
...
void BattlegroundBFG::SetEmoteAndWeapon(Team team, int8 type, Creature* me)
{
    //this is a null check, which also checks for the value to be something other than zero.
    if (team == ALLIANCE ? BFG_NPC_DATA[type].equipment_A : BFG_NPC_DATA[type].equipment_H)
        me->LoadEquipment(team == ALLIANCE ? BFG_NPC_DATA[type].equipment_A : BFG_NPC_DATA[type].equipment_H, true);//Special case
    if (team == ALLIANCE ? BFG_NPC_DATA[type].emote : BFG_NPC_DATA[type].emote)
        me->HandleEmoteCommand(team == ALLIANCE ? BFG_NPC_DATA[type].emote : BFG_NPC_DATA[type].emote);

    me->SetSheath(team == ALLIANCE ? BFG_NPC_DATA[type].sheath_A : BFG_NPC_DATA[type].sheath_H);    //mainhand offhand
...
bool BattlegroundBFG::SetupBattleground()
{
    ...
    for (uint8 node = 0; node < BG_BFG_DYNAMIC_NODES_COUNT; ++node)
    {
        if (!AddCreature(WORLD_TRIGGER, node + 5, TEAM_NEUTRAL, BG_BFG_NodePositions[node][0], BG_BFG_NodePositions[node][1], BG_BFG_NodePositions[node][2] + 1.00f, BG_BFG_NodePositions[node][3]))
            return false;
    }
    return true;
}
...
WorldSafeLocsEntry const* BattlegroundBFG::GetClosestGraveYard(Player* player)
{
    ...
    WorldSafeLocsEntry const* saved_entry = NULL;
    ...
    if (!nodes.empty())
    {
        ...
        //at this point we have "good entry" as our closest graveyard. We need to run it again with that one ruled out.

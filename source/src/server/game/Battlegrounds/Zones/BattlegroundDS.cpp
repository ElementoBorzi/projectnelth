...
void BattlegroundDS::HandleKillPlayer(Player* player, Player* killer)
{
    ...
    if (killer)
        ...
        else TC_LOG_ERROR("bg.battleground", "BattlegroundDS::HandleKillPlayer: Killer player not found");
    else TC_LOG_ERROR("bg.battleground", "BattlegroundDS::HandleKillPlayer: Victim player not found");
...
bool BattlegroundDS::SetupBattleground()
{
    ...
    // buffs
        || !AddObject(BG_DS_OBJECT_BUFF_1, BG_DS_OBJECT_TYPE_BUFF_1, 1320.980f, 762.631f, 3.159f, 2.528f, 0, 0, 0.730314f, -0.683111f, 120)
        || !AddObject(BG_DS_OBJECT_BUFF_2, BG_DS_OBJECT_TYPE_BUFF_2, 1262.254f, 819.108f, 3.160f, 5.695f, 0, 0, 0.700409f, 0.713742f, 120)
    // knockback creatures
